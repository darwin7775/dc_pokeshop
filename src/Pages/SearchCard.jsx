...
const SearchCard = () => {
    ...
    const filteredCards = cardData.filter(card => {
        ...
        const matchesSearch = !searchTerm || card.title.toLowerCase().includes(searchTerm) || card.description.toLowerCase().includes(searchTerm);
                ...
                <main className="flex-1 p-4 bg-white rounded shadow">
                    ...
                    <div className="mb-4">
                        <p className="text-sm font-semibold mb-2 flex items-center">
                            <IoIosInformationCircle className="mr-1" /> Search Results For: <span className="ml-1 text-blue-600 font-bold">"{searchTerm}"</span>
                        </p>
